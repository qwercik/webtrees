...
class RouteFactory implements RouteFactoryInterface
{
    ...
    public function route(string $route_name, array $parameters = []): string
    {
        ...
        $parameters = array_filter($parameters, static fn (string $key): bool => !str_contains($route->path, '{' . $key . '}') && !str_contains($route->path, '{/' . $key . '}') && $route->wildcard !== $key, ARRAY_FILTER_USE_KEY);
